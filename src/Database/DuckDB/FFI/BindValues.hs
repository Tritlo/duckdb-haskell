...
foreign import ccall unsafe "duckdb_bind_value"
...
-}
foreign import ccall unsafe "wrapped_duckdb_bind_hugeint"
...
-}
foreign import ccall unsafe "wrapped_duckdb_bind_uhugeint"
...
-}
foreign import ccall unsafe "wrapped_duckdb_bind_decimal"
...
foreign import ccall unsafe "duckdb_bind_uint8"
...
foreign import ccall unsafe "duckdb_bind_uint16"
...
foreign import ccall unsafe "duckdb_bind_uint32"
...
index.
-}
foreign import ccall unsafe "duckdb_bind_timestamp"
    c_duckdb_bind_timestamp :: DuckDBPreparedStatement -> DuckDBIdx -> DuckDBTimestamp -> IO DuckDBState

{- | Binds a duckdb_timestamp value to the prepared statement at the specified
index.
-}
foreign import ccall unsafe "duckdb_bind_timestamp_tz"
...
-}
foreign import ccall unsafe "wrapped_duckdb_bind_interval"

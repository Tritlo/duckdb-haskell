...
--
-- Returns The vector.
foreign import ccall unsafe "duckdb_create_vector"
...
foreign import ccall unsafe "duckdb_destroy_vector"
...
foreign import ccall unsafe "duckdb_vector_get_column_type"
...
foreign import ccall unsafe "duckdb_vector_assign_string_element"
...
foreign import ccall unsafe "duckdb_vector_assign_string_element_len"
...
foreign import ccall unsafe "duckdb_list_vector_get_child"
...
foreign import ccall unsafe "duckdb_list_vector_get_size"
...
foreign import ccall unsafe "duckdb_list_vector_set_size"
...
--
-- Returns The duckdb state. Returns DuckDBError if the vector is nullptr.
foreign import ccall unsafe "duckdb_list_vector_reserve"
...
--
-- Returns The child vector
foreign import ccall unsafe "duckdb_struct_vector_get_child"
...
--
-- Returns The child vector
foreign import ccall unsafe "duckdb_array_vector_get_child"
...
foreign import ccall unsafe "duckdb_slice_vector"
...
foreign import ccall unsafe "duckdb_vector_copy_sel"
...
foreign import ccall unsafe "duckdb_vector_reference_value"
...
foreign import ccall unsafe "duckdb_vector_reference_vector"

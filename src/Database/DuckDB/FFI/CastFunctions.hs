...
foreign import ccall unsafe "duckdb_create_cast_function"
...
foreign import ccall unsafe "duckdb_cast_function_set_source_type"
...
foreign import ccall unsafe "duckdb_cast_function_set_target_type"
...
foreign import ccall unsafe "duckdb_cast_function_set_implicit_cast_cost"
...
foreign import ccall unsafe "duckdb_cast_function_set_function"
...
--   (if any)
foreign import ccall unsafe "duckdb_cast_function_set_extra_info"
...
foreign import ccall unsafe "duckdb_cast_function_get_extra_info"
...
foreign import ccall unsafe "duckdb_cast_function_get_cast_mode"
...
foreign import ccall unsafe "duckdb_cast_function_set_error"
...
foreign import ccall unsafe "duckdb_cast_function_set_row_error"
...
foreign import ccall unsafe "duckdb_register_cast_function"
...
-- Parameters:
-- * @cast_function@: The cast function object.
foreign import ccall unsafe "duckdb_destroy_cast_function"
